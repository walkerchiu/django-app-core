...
from django_app_core.graphql_jwt import mixins
from django_app_core.graphql_jwt.decorators import token_auth
from django_app_core.graphql_jwt.refresh_token.relay import (
...
if DJANGO_APP_TENANT_INSTALLED:
    from django_app_tenant.models import Tenant
...
class JSONWebTokenMutation(mixins.ObtainJSONWebTokenMixin, graphene.ClientIDMutation):
    ...
    def mutate(cls, root, info, input):
        ...
        if (
            ...
            and DJANGO_APP_TENANT_INSTALLED
        ):
